...
Use `mcp__Notion__notion-update-page` or `mcp__Notion__notion-create-pages` — whichever exposes an "append children" operation for an existing page. Use `mcp__Notion__notion-fetch` first to confirm the page exists.
