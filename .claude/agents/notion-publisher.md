...
tools: Read, mcp__Notion__notion-fetch, mcp__Notion__notion-update-page, mcp__Notion__notion-create-pages, mcp__Notion__notion-search, mcp__Notion__notion-list-recent-pages
---
...
Use `mcp__Notion__notion-update-page` to append children to the existing page. If that fails, try `mcp__Notion__notion-create-pages` to create a sub-page instead. Use `mcp__Notion__notion-fetch` to read the page first and confirm it exists.
