...
Use **`mcp__Notion__notion-update-page`** to append children to the page with ID `page_id`.
...
If `notion-update-page` does not support appending block children, fall back to **`mcp__Notion__notion-create-pages`** to create a new child page with the post content.
