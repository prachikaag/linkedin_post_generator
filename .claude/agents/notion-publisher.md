...
Use `mcp__Notion__notion-update-page` or `mcp__Notion__notion-create-pages` — whichever supports appending blocks to an existing page.
First call `mcp__Notion__notion-fetch` with the page_id to confirm the page exists before writing.
